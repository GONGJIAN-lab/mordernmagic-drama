...
class WebhookService {
    ...
    // 支付成功：更新订单 + 发货（解锁剧集）
    // ============================================================
    async handleTradeOrderSuccess(data) {
    ...
    // 支付失败：更新订单状态，记录失败原因
    // ============================================================
    async handleTradeOrderFail(data) {
    ...
    // 订阅续费：更新过期时间
    // ============================================================
    async handleSubscriptionRenew(data) {
    ...
    // 订阅过期：更新状态，回收权益
    // ============================================================
    async handleSubscriptionExpire(data) {
